...
ifeq ($(UNAME), FreeBSD)
LINKS += -g -L./lib -lcolib -lpthread -lhiredis
else
LINKS += -g -L./lib -lcolib -lpthread -ldl -lhiredis
endif
COLIB_OBJS=co_epoll.o co_routine.o co_hook_sys_call.o coctx_swap.o coctx.o
#co_swapcontext.o

PROGS = colib new
#example_poll example_echosvr example_echocli example_thread  example_cond example_specific example_copystack example_closure new
